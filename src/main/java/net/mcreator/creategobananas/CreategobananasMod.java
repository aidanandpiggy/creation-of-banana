package net.mcreator.creategobananas;
...
import net.mcreator.creategobananas.init.CreategobananasModItems;
...
@Mod("creategobananas")
public class CreategobananasMod {
	public static final Logger LOGGER = LogManager.getLogger(CreategobananasMod.class);
	public static final String MODID = "creategobananas";

	public CreategobananasMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		CreategobananasModItems.REGISTRY.register(modEventBus);
